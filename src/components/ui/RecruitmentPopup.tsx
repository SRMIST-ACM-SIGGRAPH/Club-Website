              ...
              <div className="relative flex flex-col items-center text-center">
                ...
                <div className="mb-6 relative flex items-center justify-center">
                  ...
                  <div className="relative w-16 h-16 rounded-full overflow-hidden border-2 border-[#FF6B1A] shadow-[0_0_20px_rgba(255,107,26,0.4)]">
                    <img src="/logo.jpg" alt="ACM SIGGRAPH SRM" className="w-full h-full object-cover" />
                  </div>
                </div>
                ...
                <p className="mb-8 text-sm text-neutral-400 font-sans leading-relaxed px-1">
                  Ready to shape the future of computer graphics, interactive media, and emerging technology? Apply now to join the creative developers, 3D artists, and visionaries of ACM SIGGRAPH SRM.
                </p>
